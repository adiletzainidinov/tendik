...
export const QUICK_CONTACT_MESSAGE =
  "Ассаламу алейкум! QoranLearn Куран курсу тууралуу маалымат алгым келет.";

export function buildRegistrationMessage(data: RegistrationForm): string {
  return [
    "Ассаламу алейкум!",
    "QoranLearn Куран курсуна баламды каттагым келет.",
    "",
